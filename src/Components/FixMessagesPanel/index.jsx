...
export default function FixMessagesPanel({ engineID, engineName, sessionID }) {
  ...
  const [messagesGridHeight, setMessagesGridHeight] = useState(297);
  const [descriptionGridHeight, setDescriptionGridHeight] = useState(297);
  const [messagesPageSize, setMessagesPageSize] = useState(7);
  const [descriptionPageSize, setDescriptionPageSize] = useState(7);
